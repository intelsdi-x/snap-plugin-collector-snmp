...
func getCorrectConfig1() Metrics {
	metricConfig := []Metric{Metric{
		...
		Namespace: []namespace{namespace{Source: "string", String: "test1"},
			...
			namespace{Source: "snmp", Oid: ".1.3.6.1.2.1.1.9.1.3", Name: "name1"},
			namespace{Source: "snmp", Oid: ".1.3.6.1.2.1.1.9.1.3", Name: "name2"},
			namespace{Source: "index", OidPart: "9", Name: "name3"},
...
func getCorrectConfig4() Metrics {
	metricConfig := []Metric{Metric{
		Oid:       ".1.3.6.1.2.1.1.9.1.3",
		Namespace: []namespace{namespace{Source: "snmp", Oid: ".1.3.6.1.2.1.1.9.1.3", Name: "name1"}, namespace{Source: "string", String: "test2"}},
	}}
	return metricConfig
}
...
func getWrongConfig3() Metrics {
	metricConfig := []Metric{Metric{
		Oid: ".1.3.6.1.2.1.1.2.0",
		Namespace: []namespace{
			namespace{Source: "snmp", Oid: ".1.3.6.1.2.1.1.9.1.3"},
		},
		Unit:        "unit",
...
func getWrongConfig4() Metrics {
	metricConfig := []Metric{Metric{
		Oid: ".1.3.6.1.2.1.1.2.0",
		Namespace: []namespace{
			namespace{Source: "index", OidPart: "9"},
		},
	}}
	return metricConfig
}
...
func getWrongConfig5() Metrics {
	metricConfig := []Metric{Metric{
		Oid: ".1.3.6.1.2.1.1.2.0",
		Namespace: []namespace{
			namespace{Source: "snmp", Name: "name1"},
		},
		Unit:        "unit",
		Description: "description",
	}}
...
func getWrongConfig6() Metrics {
	metricConfig := []Metric{Metric{
		Oid: ".1.3.6.1.2.1.1.2.0",
		Namespace: []namespace{
			namespace{Source: "index", Name: "name3"},
		},
		Unit:        "unit",
		Description: "description",
	}}
